...
startup (GApplication *app)
{
  ...
  gtk_builder_add_from_resource (builder, "/com/example/app/menus.ui", NULL);
...
demo_application_window_class_init (DemoApplicationWindowClass *class)
{
  ...
  gtk_widget_class_set_template_from_resource (widget_class, "/com/example/app/application.ui");
